    ...
    <div className='flex flex-col items-center justify-center bg-black font-openSans'>
        ...
        <div className='flex flex-col text-white items-center text-center'>
            ...
            <div className='flex flex-row items-center justify-center gap-8 pt-4'>
                ...
                <img src={findingsNInsights} alt="finding + insights" style={{height: '30vh', width: '100%', padding: 8}} />
            </div>
        </div>
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='pt-4 flex flex-col gap-4'>
                <img src={q5} alt='q5' style={{padding: 4, height: '100%', width: '40vw'}}/>
                <img src={q10} alt='q10' style={{padding: 4, height: '100%', width: '40vw'}}/>
                <img src={survery} alt='survey' style={{padding: 4, height: '100%', width: '40vw'}}/>
          </div>
        </div>
        ...
        <div className='flex flex-col text-white items-center text-center'>
            ...
            <div className='font-bold items-center pt-8'>
              <div className='text-xl pb-4'> 
                ...
                <div className=' flex items-center justify-center'>
                  <ul className='flex flex-col list-disc list-inside text-left pl-8 pt-4' style={{width: '30vw' }}>
                    <li>
          ...
          <div>
            ...
            <img alt='competitor' src={competitor} 
                style={{padding: 4, height: '100%', width: '50vw'}}
            />
          </div>
        </div>
        <div className='flex flex-col text-white items-center text-center pt-4'>
            ...
            <div className='flex flex-row items-center justify-center gap-4 pt-4'>
              <div className='flex flex-col gap-4 items-center justify-center'>
                <span className='text-mustard-yellow text-lg font-semibold'>
                  Scenario: Marwa's Job Search Journey on “illuminate”
                </span>
                <img alt='marwa' src={marwa} 
                // style={{padding: 4, height: '100%', width: '30vw'}}
                  style={{padding: 4, height: '35vh', width: '100%'}}
                  />
                <img src={journeyMap} alt='journey map' 
              // style={{padding: 4, height: '100%', width: '30vw'}}
                style={{padding: 4, height: '45vh', width: '100%'}}
                />
              </div>
              
            </div>
            <h3 className='font-bold text-xl pb-8 pt-8'>
              User Flow<br/>
            </h3>
            <img alt='user flow' src={userFlow} style={{padding: 4, height: '100%', width: '50vw'}}/>
            <h3 className='font-bold text-xl pb-4 pt-8'>
              Sample Low-fidelity Wireframes<br/>
            </h3>

            <div className='flex flex-col'>
              <h3 className='font-bold text-xl pb-4 pt-4 text-center'>
                Home Screen<br/>
        ...
        <div className='flex flex-col text-white items-center justify-center text-center pt-8'>
          ...
          <p className='font-light text-white text-left text-wrap text-lg' style={{width: '30vw'}}>
