  ...
  return (
    <div className='flex flex-col items-center justify-center bg-black'>
        ...
        <div className='pt-8 flex flex-col text-white items-center ' style={{width: '20vw'}}> 
            <p>
                <span className='font-bold'>Role:</span> Project Manager + UX Designer/Researcher<br/><br/>
                <span className='font-bold'>Duration:</span> May 2023 - August 2023<br/><br/>
            </p>
        </div>
        <div className='flex flex-col text-white items-center text-center justify-center'>
            ...
            <h3 className='font-bold text-3xl pb-4'>The Problem</h3>
            <p className='text-left items-center justify-center text-lg font-light' style={{width: '25vw'}}>
              “Aimbridge Hospitality needs a standardized and <br/>
              centralized project tracking format to ensure <br/>
        ...
        <div className='flex flex-col text-white items-center text-center justify-center'>
            <h2 className='font-bold text-baby-blue text-3xl pt-8 pb-8'>Part 1: Research + Empathize </h2>
            <h3 className='font-bold text-2xl pb-8'>User Research</h3>
            <div className='pb-2 text-lg text-left' style={{width: '25vw'}} >
                ...
                <span >Usability testing amongst Hotel Tech, A3, RPA, and LATAM: </span>
                <ul className="list-disc p-6">
                    <li>
            ...
            <img alt='context diagram' src={empathyMap} style={{width: '25vw', height: '100%'}}/>
            <span className='p-4 text-left' style={{width: '30vw'}}>
        ...
        <div className='flex flex-col text-white items-center text-center justify-center'>
            <h2 className='font-bold text-baby-blue text-3xl pt-8 pb-8'>Part 2: Define the Solution </h2>
            <p className='text-left pb-4' style={{width: '25vw'}}>
            ...
            <img alt='SWOT' src={SWOT} style={{width: '100%', height: '30vh'}}/>
            <h3 className='font-bold text-2xl pt-8 pb-8'>Timeline</h3>
            <img alt='time' src={timeline} style={{width: '100%', height: '30vh'}}/>
            <h3 className='font-bold text-2xl pt-8 pb-8'>Writing a Project Charter </h3>
            <img alt='charter' src={charter} style={{width: '100%', height: '30vh'}}/>
        </div>

        <div className='flex flex-col text-white items-center text-center justify-center'>
            <h2 className='font-bold text-baby-blue text-3xl pt-8 pb-8'>Part 3: Prototyping </h2>
            <h3 className='font-bold text-2xl pb-8'>Low, Mid, High-Fidelity</h3>
            <img alt='fidelity' src={fidelity} style={{width: '30vw', height: '100%'}}/>
            <h3 className='font-bold text-2xl pt-8 pb-8'>Desktop UI</h3>
            <img alt='desktopUI' src={desktopUI} style={{width: '30vw', height: '100%'}}/>
            <h3 className='font-bold text-2xl pt-8 pb-8'>Mobile UI</h3>
            <img alt='mobileUI' src={mobileUI} style={{width: '30vw', height: '100%'}}/>
        </div>

        <div className='flex flex-col text-white items-center text-center justify-center'>
            <h2 className='font-bold text-baby-blue text-3xl pt-8 pb-8'>Part 4: Testing </h2>
            <p className='text-left pb-8' style={{width: '25vw'}}>
            ...
            <img alt='dashboard' src={dashboard} style={{width: '30vw', height: '100%'}}/>
            <p className='p-4'></p>
            <img alt='mainpoints' src={mainPoints} style={{width: '30vw', height: '100%'}}/>
        </div>

        <div className='flex flex-col text-white items-center text-center justify-center'>
            <h2 className='font-bold text-baby-blue text-3xl pt-8 pb-8'>Part 5: Reflection </h2>
            <p className='text-left pb-8' style={{width: '25vw'}}>
            ...
            <img alt='guidelines' src={guidelines} style={{width: '30vw', height: '100%'}}/> 
        </div>
